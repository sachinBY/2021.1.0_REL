...
CREATE OR REPLACE PROCEDURE &SCHEMANAME.prepareToPurge
(
...
BEGIN
	...
	BEGIN
      ...
      UPDATE MS_MSG_BDY SET ACTIVE = 0 WHERE LST_UPDT_AT < (SYSDATE - p_retentionDays) AND ACTIVE = 1 and rownum <= v_BatchSize;
			v_rowCount := SQL%ROWCOUNT;
