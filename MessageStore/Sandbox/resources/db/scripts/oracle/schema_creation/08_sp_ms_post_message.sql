...
CREATE OR REPLACE PROCEDURE &SCHEMANAME.ms_post_messages
(
p_now TIMESTAMP,
p_frmt VARCHAR2,
 ...
 SAVEPOINT ms_store;
  ...
  IF 	p_failWhenDuplicate = 0
   ...
   INSERT INTO MS_MSG_EVNT(CRTD_AT, MSG_HDR_ID, STATUS, ERR_CAT, ERR_REASON, ERR_CODE, ERR_DESC, ERR_DETAIL_DESC)
		VALUES
		(p_now, p_headerId, p_sts, p_errorCategory, p_errorReason, p_errorCode, p_errorDesc, p_errorDetailedDesc);
COMMIT;
EXCEPTION
  WHEN OTHERS THEN
