...
ALTER TABLE $(SCHEMANAME).MS_BLK_HDR ADD CONSTRAINT BLK_HDR_DTLS_UK UNIQUE NONCLUSTERED (SRVC_NAME, BLK_SRC, BLK_ID)
...
ALTER TABLE $(SCHEMANAME).MS_RCRD_EVNT ADD CONSTRAINT BLK_RCRD_EVNT_ID_PK PRIMARY KEY CLUSTERED (BLK_RCRD_EVNT_ID)
...
ALTER TABLE $(SCHEMANAME).MS_RCRD_HDR ADD CONSTRAINT BLK_RCRD_HDR_ID_PK PRIMARY KEY CLUSTERED (BLK_RCRD_HDR_ID)

ALTER TABLE $(SCHEMANAME).MS_RCRD_HDR ADD CONSTRAINT BLK_HDRRCRD_ID_UK UNIQUE NONCLUSTERED (BLK_HDR_ID, RCRD_ID)
...
ALTER TABLE $(SCHEMANAME).MS_RCRD_EVNT ADD CONSTRAINT BLK_RCRDHDR_ID_FK FOREIGN KEY ( RCRD_HDR_ID ) REFERENCES $(SCHEMANAME).MS_RCRD_HDR ( BLK_RCRD_HDR_ID )

ALTER TABLE $(SCHEMANAME).MS_BLK_EVNT ADD CONSTRAINT BLK_HDRID_FK FOREIGN KEY ( BLK_HDR_ID ) REFERENCES $(SCHEMANAME).MS_BLK_HDR ( BLK_HDR_ID )
